LDAvis = function(to_select, json_file) {
    ...
    color1 = "#14773a", // baseline color for default topic circles and overall term frequencies
    color2 = "#822f8c"; // 'd62728highlight' color for selected topics and term-topic frequencies
	...
	if (xdiff > ydiff) {
        ...
        svg.append("text")
            .text("Topic View - Distance Map (via PCoA/Multidimensional Scaling)")
	...
	// dynamically create the topic and lambda input forms at the top of the page:
	    ...
	    inputDiv.appendChild(topicDiv);
            ...
            topicLabel.setAttribute("style", "font-family: courier; font-size: 14px");
	    ...
	    clear.innerHTML = "Clear Topic";
    	    ...
    	    lambdaZero.setAttribute("style", "padding: 5px; height: 20px; width: 220px; font-family: courier; float: left");
	    ...
	    lambdaLabel.setAttribute("style", "height: 20px; width: 60px; font-family: courier; font-size: 14px; margin-left: 80px");
